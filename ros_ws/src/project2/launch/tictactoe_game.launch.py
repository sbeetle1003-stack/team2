...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            '/world/tictactoe_world/create@ros_gz_interfaces/srv/SpawnEntity',
            '/world/tictactoe_world/set_pose@ros_gz_interfaces/srv/SetEntityPose',
        ],
        output='screen',
    )
    ...
    return LaunchDescription(
        ...
        + [
            ...
            vision,
            referee,
            # digital_twin_board,  # Node 객체 자체를 리스트 요소로 포함시킴
        ]
        + controller_startup
    )