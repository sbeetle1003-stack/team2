...
현재 Gazebo model resource path는 launch 파일에서 수동으로 설정해야 합니다.

다음 파일을 엽니다.

```bash
nano ~/team2/crop_active_vision/launch/crop_active_vision.launch.py

aoc_model_path를 자신의 환경에 맞게 수정합니다.

예시:

aoc_model_path = (
    '/home/<USERNAME>/team2/crop_active_vision/models'
)

<USERNAME>을 자신의 Ubuntu 사용자 이름으로 변경하세요.
