...
def generate_launch_description():
    ...
    world_path = project_path / 'worlds' / 'tomato_farm_2mx3m_gazebo_sim.sdf'
    ...
    arm_controller_spawner = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['arm_controller', '--switch-timeout', '30'],
        output='screen',
    )
    ...
    gripper_controller_spawner = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['gripper_controller', '--switch-timeout', '30'],
        output='screen',
    )
