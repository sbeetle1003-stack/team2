...
def generate_launch_description():
    ...
    tf2_basic_share_path = get_package_share_directory("tf2_basic")
    ...
    gazebo_resource_path = SetEnvironmentVariable(
        ...
        value=[
            ...
            ':' + os.path.join(tf2_basic_share_path, 'models'),
            ':' + '/home/jamiek/aoc_ws/src/aoc_tomato_farm/'
                'gz_tomato_farm_generator/generated/'
                'farm_2mx3m/models/2mx3m',
        ],
    )
